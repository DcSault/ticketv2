...
function Statistics() {
  ...
  const calculateTimeRatio = () => {
    ...
    // Simulation - dans la vraie version, il faudrait avoir les heures dans la BDD
    const total = stats.summary.total;
    const morning = Math.round(total * 0.55); // 55% le matin
  ...
  // Calculer l'heure la plus active (simulation)
  const getMostActiveTime = () => {
    const hours = ['10:00', '11:00', '14:00', '15:00', '16:00'];
