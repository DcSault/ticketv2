          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 px-4 py-2 bg-slate-800/50 rounded-lg">
              ...
              <div className="text-sm">
                <div className="text-slate-200 font-medium">{user?.fullName || user?.username}</div>
                {user?.tenantName && <div className="text-slate-400 text-xs">{user.tenantName}</div>}
              </div>
            </div>
            <button
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <svg className="w-6 h-6 text-slate-600 group-hover:text-blue-400 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <h3 className="text-2xl font-bold text-slate-100 mb-2 group-hover:text-purple-400 transition-colors">
                  Statistiques
                </h3>
                <p className="text-slate-400 text-sm">
              ...
              <svg className="w-6 h-6 text-slate-600 group-hover:text-purple-400 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </div>
          </button>
          ...
          {user?.role === 'global_admin' && (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <svg className="w-6 h-6 text-slate-600 group-hover:text-red-400 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </div>
            </button>
