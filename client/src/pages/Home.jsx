      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
          <h2 className="text-5xl font-bold text-gray-800 mb-4">
            Bienvenue <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{user?.fullName || user?.username}</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="relative flex items-start justify-between">
              ...
              <svg className="w-6 h-6 text-gray-300 group-hover:text-blue-600 group-hover:translate-x-2 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="relative flex items-start justify-between">
              ...
              <svg className="w-6 h-6 text-gray-300 group-hover:text-purple-600 group-hover:translate-x-2 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </div>
          </button>
          ...
          {user?.role === 'global_admin' && (
            ...
            >
              ...
              <div className="relative flex items-start justify-between">
                ...
                <svg className="w-6 h-6 text-gray-300 group-hover:text-red-600 group-hover:translate-x-2 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </div>
            </button>
